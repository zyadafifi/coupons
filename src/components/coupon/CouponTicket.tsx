...
export function CouponTicket({
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute left-0 top-[105px] sm:top-[115px] md:top-[120px] -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 rounded-full z-10 bg-background"
      />
      <div 
        className="absolute right-0 top-[105px] sm:top-[115px] md:top-[120px] -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 rounded-full z-10 bg-background"
      />
        ...
        <div className="relative px-4 py-5 pb-7 sm:px-5 sm:py-6 sm:pb-8 bg-primary">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1 text-primary-foreground">
              <p className="text-base sm:text-lg font-medium mb-0.5 sm:mb-1 opacity-95">{discount}</p>
              <p className="font-mono font-bold text-xl sm:text-2xl tracking-wider">{code}</p>
            </div>
          </div>
        </div>
